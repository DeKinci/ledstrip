...
static constexpr uint8_t BLE_CMD_RESET_STATS  = 0x08; // (empty) — zeros all stats counters
static constexpr uint8_t BLE_CMD_START_SPEEDTEST       = 0x09; // [count:2][interval_ms:2][payload_size:1]
static constexpr uint8_t BLE_CMD_GET_SPEEDTEST_RESULTS = 0x0A; // (empty)
...
static constexpr uint8_t BLE_RESP_SPEEDTEST_RESULTS = 0x86; // 44-byte results or 2-byte status
